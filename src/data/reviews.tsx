export const reviewsData = [
  {
    ...
    review:
      "Eu gostaria de expressar minha mais alta recomendação. Durante o tempo em que trabalhei com ele fiquei impressionado com sua habilidade e capacidade de unir o grupo em torno de objetivos em comuns. Um conhecimento profundo em desenvolvimento em várias stacks e usa esse conhecimento para propor soluções inovadoras e eficientes. Projetos incríveis. Além disso, é extremamente proativo e sempre busca maneiras de melhorar o processo de desenvolvimento e otimizar o trabalho em equipe. Tem uma personalidade alegre e contagiante que inspira os outros a seguir em frente e alcançar resultados juntos. Em resumo, acredito que é um incansável desenvolvedor full-stack talentoso, e estou confiante de que continuará a se destacar em sua carreira. Eu recomendo sem reservas para qualquer equipe que busque um desenvolvedor altamente capacitado e dedicado.",
  },
  {
    ...
    job: "Desenvolvedor de Software",
    review:
      "Adam é um excelente profissional e consigo falar isso com total autoria, já que tive o prazer de liderar ele durante sua experiência de monitor front-end na Kenzie Academy. Além das habilidades técnicas que ele adquiria com facilidade, deixo meu destaque pela paixão que esse cara tem pela comunidade, por ajudar pessoas e a vontade gigante de criar algo, um talento. Adam criou uma comunidade nomeada 'Os campeões(ãs)', e vem ajudado a galera desde então. Não posso deixar de destacar o período que fui instrutor dele, e o grupo do projeto no qual ele fazia parte nos surpreendeu com um projeto incrível, usando tecnologias além das que tínhamos ensinado, mostrando claramente que tinham proatividade e sede por aprender, o projeto ficou incrível. Bom, se você leu até aqui, acredito que nesse momento já está chamando o Adam para bater aquele papo, para convidar ele para entrar no seu time, eu não perderia por nada!",
  },
  {
...

  {
    ...
    job: "Desenvolvedor de Software",
    review:
      "Adam é um desenvolvedor excepcional. sempre demonstrou habilidades técnicas notáveis, destacando-se em lógica de programação e mantendo-se atualizado com as últimas tendências. Sua proatividade e disposição para ajudar colegas são evidentes, contribuindo para melhorias contínuas nos processos da equipe. Adam é não apenas um profissional talentoso, mas também um colega de equipe exemplar, com habilidades interpessoais notáveis que criam um ambiente de trabalho positivo. Sua expertise em User Experience (UX) resultou em interfaces intuitivas e agradáveis em nossos projetos. Em resumo, Adam é uma adição valiosa para qualquer equipe de desenvolvimento, e estou confiante de que continuará a ter um impacto positivo em seus futuros desafios profissionais.",
  },
  {
